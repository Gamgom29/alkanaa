...
use App\Http\Controllers\Payment\MoyasarController as PaymentMoyasarController;
...
Route::controller(HomeController::class)->group(function () {
    ...
    //service request
    Route::post('/service-request', 'service_request_store')->name('service-request.store');
    Route::any('/quotation-request', 'quotation_request_store')->name('quotation.post');
    ...
    // web.php
    Route::get('/cart/summary-toast', [CartController::class, 'getCartSummaryToast'])->name('cart.summary.toast');
    Route::get('/cart/offcanvas', [CartController::class, 'offcanvas'])
        ->name('cart.offcanvas');
    ...
    Route::get('/get-a-quote', function () {
        return view('frontend.classic.get_quote');
    })->name('get-a-quote');

    Route::get('/maintainence-request', function () {
        return view('frontend.classic.maintainence_request');
    })->name('maintainence-request');

    Route::post('/get-a-quote', 'send_quote')->name('quote.submit');

    Route::get('/service-request', 'service_request')->name('service-request');
    ...
    Route::post('/company/edit', 'edit_company')->name('company.edit');
    ...
    //route for partners its name is all-our-partners
    Route::get('/all-our-partners', 'all_our_partners')->name('all-our-partners');
});
...
Route::post('/language', [LanguageController::class, 'changeLanguagePost'])->name('language.change.post');
...
Route::get('/payment/moyasar/return', [PaymentMoyasarController::class, 'return'])->name('moyasar.return');
Route::post('/payment/moyasar/webhook', [PaymentMoyasarController::class, 'webhook'])->name('moyasar.webhook');

Route::get('/moyasar/pay/{combined_order_id}', [\App\Http\Controllers\Payment\MoyasarController::class, 'form'])
    ->name('moyasar.form');

Route::get('/moyasar/callback', [\App\Http\Controllers\Payment\MoyasarController::class, 'callback'])
    ->name('moyasar.callback');


Route::post('/payment/tabby/start', [TabbyController::class, 'start'])->name('tabby.start');
Route::get('/payment/tabby/success', [TabbyController::class, 'success'])->name('tabby.success');
Route::get('/payment/tabby/cancel', [TabbyController::class, 'cancel'])->name('tabby.cancel');

// Webhook الأفضل يبقى POST وممكن في api.php مع CSRF off
Route::post('/webhooks/tabby', [TabbyController::class, 'webhook'])->name('tabby.webhook');
