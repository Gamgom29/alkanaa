...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        $productData['is_stainless'] = $request->has('is_stainless') ? 1 : 0;
        $productData['service_fee'] = $request->has('service_fee') ? $request->service_fee : 0;
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ->where('digital', 0)->orderBy('level','asc')->orderBy('parent_id','asc')
            ->with('childrenCategories')
            ->get();
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        // add service fee
        $product->service_fee = $request->filled('service_fee') ? floatval($request->service_fee) : 0;
        $product->save();
