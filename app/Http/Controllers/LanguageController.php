...
class LanguageController extends Controller
{
    ...
    public function changeLanguage(Request $request, $locale = null)
    {
        ...
        if ($language) {
            $request->session()->put('langcode', $language->app_lang_code);
            flash(translate('Language changed to ') .' '. translate($language->name))->success();
        } else {
    ...
    public function changeLanguagePost(Request $request)
    {
        $request->session()->put('locale', $request->locale);
    ...
    public function exportARBFile($id)
    {
        ...
        try {
            ...
            \Log::error('ARB export failed: ' . $e->getMessage(), ['exception' => $e]);
