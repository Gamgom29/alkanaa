...
class MyfatoorahController extends Controller
{
    ...
    {
        return [
            'apiKey' => env('MYFATOORAH_TOKEN') ?: config('myfatoorah.api_key'),
            'isTest' => function_exists('get_setting') && get_setting('myfatoorah_sandbox') == 1,
            'countryCode' => env('MYFATOORAH_COUNTRY_ISO') ?: config('myfatoorah.country_iso'),
        ];
    }
