            ...
            <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">Mark as Stainless Steel</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="is_stainless" value="1"
                                        @if ($product->is_stainless == 1) checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <label for="service_fee" class="fw-700">Service Fee</label>
                            <input type="number" step="0.01" min="0" name="service_fee" id="service_fee" value="{{ $product->service_fee }}"
                                class="form-control" placeholder="Enter Service Fee">
                        </div>
