...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/aiz-core.css') }}?v={{ static_asset_version('assets/css/aiz-core.css') }}">
...
<body>
    ...
    <script src="{{ static_asset('assets/js/aiz-core.js') }}?v={{ static_asset_version('assets/js/aiz-core.js') }}" ></script>
