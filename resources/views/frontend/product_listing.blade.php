...
@section('script')
    <script type="text/javascript">
        ...
        // formatPrice / mountMiniCartToastNearCart / .add-to-cart-btn handler
        // are now global (frontend/layouts/app.blade.php) — removed the
        // page-local duplicate that used to live here to avoid double-
        // binding the click handler (which would double-add to cart).
