...
@section('panel_content')
    ...
    <div class="row gutters-16 mt-2">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="px-4 bg-white border h-100">
                ...
                <div class="d-flex align-items-center py-4 border-bottom">
                    ...
                    <div class="ml-3 d-flex flex-column justify-content-between m-3">
                        @php
                            $cart = get_user_cart();
                        @endphp
        ...
        @if (Auth::user()->is_company)
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="p-4 border h-100">
                    <h6 class="fw-700 mb-3 text-dark">{{ translate('Company Data') }}</h6>
                    @if ($company != null)
                        @if ($company != null)
                            <ul class="list-unstyled mb-5">
                                <li class="fs-14 fw-400 text-derk pb-1"><span>{{ translate('company_name') }} :
                                        {{ $company->company_name }}</span></li>
                                <li class="fs-14 fw-400 text-derk pb-1"><span>{{ translate('tax_number') }} :
                                        {{ $company->tax_number }}</span></li>
                                <li class="fs-14 fw-400 text-derk pb-1"><span>{{ translate('commercial_register') }} :
                                        {{ $company->commercial_register }}</span></li>
                            </ul>
                        @endif
                    @endif
                    <button class="btn btn-dark btn-block fs-14 fw-500" onclick="edit_company()"
                        style="border-radius: 25px;">
                        <i class="la la-pen fs-18 fw-700 mr-2"></i>
...
@section('modal')
    ...
    @if (app()->getLocale() == 'sa')
        <!-- Modal: تعديل بيانات الشركة (عربي) -->
                ...
                <form method="POST" action="{{ route('company.edit') }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label text-white">اسم الشركة</label>
                                <input type="text" name="company_name" value="{{ $company?->company_name }}"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-white">الرقم الضريبي</label>
                                <input type="text" name="tax_number" value="{{ $company?->tax_number }}"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-white">السجل التجاري</label>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <form method="POST" action="{{ route('company.edit') }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label text-white">公司名称</label>
                                <input type="text" name="company_name" value="{{ $company?->company_name }}"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-white">税号</label>
                                <input type="text" name="tax_number" value="{{ $company?->tax_number }}"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-white">商业登记号</label>
                                <input type="text" name="commercial_register"
                                    value="{{ $company?->commercial_register }}" class="form-control">
                            </div>
                        </div>
                ...
                <form method="POST" action="{{ route('company.edit') }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label text-white">Tax Number</label>
                                <input type="text" name="tax_number" value="{{ $company?->tax_number }}"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
                                <label class="form-label text-white">Commercial Registration</label>
                                <input type="text" name="commercial_register"
                                    value="{{ $company?->commercial_register }}" class="form-control">
                            </div>
                        </div>
